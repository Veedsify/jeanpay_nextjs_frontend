...
const PaymentCardIcon: React.FC<PaymentCardIconProps> = ({ type = 'generic', size = 'md' }) => {
  ...
  return (
    <div className={`${sizeClasses[size]} bg-white rounded-lg border-2 border-gray-100 shadow-sm flex items-center justify-center`}>
      {getCardContent()}
    </div>
  );
};
