...
import { Layout } from "next/font/google";
import "../globals.css";
    ...
    <html lang="en">
      <body className={`${font.className} bg-green-bg`}>
        <div className="mx-auto flex min-h-screen">
          ...
          {/* Main Content */}
          <div className="2xl:flex-1 lg:px-7 py-4 w-full flex flex-col bg-white rounded-tl-2xl lg:rounded-tl-2xl">
            {/* Desktop Header */}
            <div className="hidden lg:block">
              <DashboardHeader />
            </div>
            ...
            <div className="flex-1 mt-2 lg:mt-2 pt-16 lg:pt-0">{children}</div>
