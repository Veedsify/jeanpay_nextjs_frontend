...
//                           <h3 className="font-medium text-gray-900 md:text-sm mb-1">
//                             {notification.title}
//                           </h3>
...
export default function NotificationsPage() {
  ...
  return (
    <div className="w-[90%] lg:w-full rounded-xl border shadow-md border-black/90 mt-6 mx-auto bg-gray-50 overflow-hidden">
      {/* Header */}
              ...
              >
                <div className="flex items-start justify-between">
                  <div className="flex items-start gap-2 flex-1 min-w-0">
                    ...
                    <div className="flex-shrink-0 mt-0.5">
                      <input
                        ...
                        checked={notification.selected}
                        onChange={() => toggleCheckbox(notification.id)}
                        className="w-3.5 h-3.5 text-cyan-600 bg-gray-100 border-gray-300 rounded focus:ring-cyan-500 focus:ring-1"
                      />
                    </div>
                  ...
                  <div className="flex flex-col items-end gap-1 ml-2 flex-shrink-0">
                    ...
                    <button 
                      onClick={() => toggleStar(notification.id)}
                      className="p-0.5 text-gray-400 hover:text-yellow-500 transition-colors"
                      aria-label={notification.starred ? "Unstar notification" : "Star notification"}
                    >
                      <Star 
                        size={14} 
