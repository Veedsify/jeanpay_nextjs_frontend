...
const InstantTransferSection = memo(
  ({ className = "" }: InstantTransferSectionProps) => {
    return (
      <section
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Send money instantly to friends and family, or get paid by anyone
              with our innovative transfer methods.
            </p>
          </motion.div>
