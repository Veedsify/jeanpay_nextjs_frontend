...
interface CountryFlagProps {
  country: "nigeria" | "ghana" | "togo" | "ivory-coast";
  size?: "sm" | "md" | "lg";
  className?: string;
}
...
export function CountryFlag({
  ...
  const flagComponents: Record<string, React.ReactNode> = {
    ...
    ghana: (
      ...
      >
        ...
        <polygon
          points="450,220 462,256 500,256 470,278 482,314 450,292 418,314 430,278 400,256 438,256"
          fill="#000000"
        />
      </svg>
    ),
    ...
    egypt: (
      ...
      >
        ...
        <g transform="translate(450,300)">
          ...
          <polygon
            points="0,-40 12,-12 40,-12 20,8 32,36 0,16 -32,36 -20,8 -40,-12 -12,-12"
            fill="#000000"
          />
        </g>
      </svg>
    ...
    morocco: (
      ...
      >
        ...
        <g transform="translate(450,300)">
          <polygon
            points="0,-80 24,-24 80,-24 32,16 56,72 0,32 -56,72 -32,16 -80,-24 -24,-24"
            fill="#006233"
            stroke="#006233"
            strokeWidth="3"
          />
    ...
    ethiopia: (
      ...
      >
        ...
        <polygon
          points="450,240 465,285 510,285 475,315 490,360 450,330 410,360 425,315 390,285 435,285"
          fill="#fcdd09"
        />
      </svg>
    ),
    ...
    senegal: (
      ...
      >
        ...
        <polygon
          points="450,200 470,260 530,260 485,300 505,360 450,320 395,360 415,300 370,260 430,260"
          fill="#00853f"
        />
      </svg>
    ),
  ...
  if (!flagElement) {
    ...
    return (
      <span
        className={`${sizeClasses[size]} ${className} bg-gray-200 rounded`}
      />
    );
  }
