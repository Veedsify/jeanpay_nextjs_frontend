...
export const TESTIMONIALS: Testimonial[] = [
  {
    ...
    avatar: 'https://pbs.twimg.com/profile_images/1505596499874451458/tq4ebWNw_400x400.jpg',
    rating: 5,
    verified: true
  },
  {
    ...
    avatar: 'https://pbs.twimg.com/profile_images/1545084992497647616/tHw_fN4U_400x400.jpg',
    rating: 5,
    verified: true
  },
  {
    ...
    avatar: 'https://pbs.twimg.com/profile_images/1549415496412061696/F00IuD71_400x400.jpg',
    rating: 5,
    verified: true
  },
  {
    ...
    avatar: 'https://pbs.twimg.com/profile_images/1498967922244235264/3G3c8s-F_400x400.jpg',
    rating: 5,
    verified: false
  },
  {
    ...
    avatar: 'https://images.unsplash.com/photo-1494790108755-2616b9f3c98a?w=150&h=150&fit=crop&crop=face',
    rating: 5,
    verified: true
  },
  {
...
export const MONEY_DESTINATIONS: MoneyDestination[] = [
  { flag: '🇬🇭', country: 'Ghana', code: 'GH', available: true, processingTime: '5 minutes' },
...
export const FAQS: FAQ[] = [
  {
    ...
    answer: 'With JeanPay, you can send and receive money across Africa and the US, get a virtual USD card for online shopping, save money with high-yield accounts, and manage your finances with our intuitive mobile app.',
    category: 'general'
  },
  {
    id: 'faq-2',
    question: 'How long does it take to send money?',
    answer: 'Most transfers are completed within 5-30 minutes depending on the destination country. We offer some of the fastest processing times in the industry.',
    category: 'transfers'
  },
  {
    id: 'faq-3',
    question: 'How many countries can I send money to?',
    answer: 'We currently support money transfers to 11+ African countries and the United States, with more countries being added regularly.',
    category: 'availability'
  },
  {
    id: 'faq-4',
    question: 'What are your fees?',
    answer: 'We offer transparent, low fees with no hidden charges. Fees vary by destination and transfer method, but we always show you the exact cost upfront.',
    category: 'fees'
  },
  {
    id: 'faq-5',
    question: 'Is my money safe with JeanPay?',
    answer: 'Yes! We use bank-level security, encryption, and are fully licensed and regulated. Your funds are protected by industry-leading security measures.',
    category: 'security'
  },
  {
    id: 'faq-6',
    question: 'How do I get a virtual USD card?',
    answer: 'Simply sign up for a JeanPay account and you can request your virtual USD card instantly through our mobile app. It\'s ready to use in minutes!',
    category: 'cards'
  }
];
...
export const CONTACT_INFO = {
  ...
  support: {
    email: 'support@jeanpay.com',
    phone: '+1 (555) 123-4567',
    hours: '24/7'
  },
  business: {
    email: 'business@jeanpay.com',
